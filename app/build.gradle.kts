...
val datadogClientToken: String =
    localProperties.getProperty("datadog.client.token")
        ?: System.getenv("DATADOG_CLIENT_TOKEN")
        ?: ""
val datadogApplicationId: String =
    localProperties.getProperty("datadog.application.id")
        ?: System.getenv("DATADOG_APPLICATION_ID")
        ?: ""

android {
    namespace = "com.example.demodatadog"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.example.demodatadog"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
